...
$(document).ready(function(){
	...
	$('body').on('click', '#invoice_button', function(){
		...
		for (i = 0; i < rows.length; i++){
			...
			$('.modal-item-row:last').append('<td>' + price + ' ' + '<span>' + USD + '</span></td>');
		}
